...
/***************************************** Member Payment **************************************/
  public function member_payment(){
    ...
    // Complete Profile...
    if ($adv_member_info[0]['country_id'] == '' || $adv_member_info[0]['state_id'] == '' || $adv_member_info[0]['district_id'] == '' || $adv_member_info[0]['tahasil_id'] == '' || $adv_member_info[0]['religion_id'] == '' || $adv_member_info[0]['cast_id'] == '' || $adv_member_info[0]['education_id'] == '' || $adv_member_info[0]['occupation_id'] == '' || $adv_member_info[0]['marital_status'] == '' || $adv_member_info[0]['marriage_type_id'] == '') {
      header('location:'.base_url().'Member/complete_profile');
    }
