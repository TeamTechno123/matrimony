        ...
        <div class="col-md-9">
                  ...
                  <div class="card card-red" style="width: 100%;">
                    <div class="card-body">
                      <div class="img w-100 text-center">
                        <div class="row owl-main">
                          <div class="owl-carousel owl-theme">
                            <div class="item"> <a target="_blank" href="<?php echo base_url(); ?>assets/images/profile-girl.jpg"> <img src="<?php echo base_url(); ?>assets/images/profile-girl.jpg" width="100" alt=""> </a></div>
                            <div class="item"><img src="<?php echo base_url(); ?>assets/images/profile-girl.jpg" width="100" alt=""></div>
                            <div class="item"><img src="<?php echo base_url(); ?>assets/images/profile-girl.jpg" width="100" alt=""></div>
                            <div class="item"><img src="<?php echo base_url(); ?>assets/images/profile-girl.jpg" width="100" alt=""></div>
                            <div class="item"><img src="<?php echo base_url(); ?>assets/images/profile-girl.jpg" width="100" alt=""></div>
                          </div>
                      ...
                      <table width="100%" class="profile-table-left" >
                        ...
                        <hr class="white">
                        <button type="button" class="btn btn-sm btn-primary w-100 btn-profile pl-1 btn-modal" data-toggle="modal" data-target=".bd-example-modal-lg">Update Profile</button>
                      </div>
                     </div>
                  </div>
          ...
          <div class="col-md-8">
            <div class="frist">
              ...
              <table class="table table-striped tbl_mem_info">
                <tbody>
                  <tr>
                     <th scope="row" class="text-danger" colspan="4"><?php echo $member_info[0]['member_name']; ?></th>
                  </tr>
                  <tr>
                    <td>Member ID : </td>
                     <td class="text-danger" colspan="3"><?php echo $member_info[0]['member_id']; ?></td>
                  </tr>
                  <tr>
                    <td>Gender : </td>
