...
<div class="wrapper">
  ...
  <table class="table table-bordered mb-0 invoice-table" Width="100%">
    ...
    <?php foreach ($adv_invoice_info as $invoice_info) {
      // code...
    } ?>
    <tr >
    ...
    <tr>
      <td colspan="4" Width="60%" style="padding-top:10px;padding-bottom:10px;">
        ...
        <p> <b>Name : <?php echo $invoice_info->user_name; ?></b>  </p>
        <p> <b>Mobile : <?php echo $invoice_info->user_mobile; ?></b>  </p>
        <p> <b>Address</b> : <?php echo  $invoice_info->user_city; ?></p>
        <p> <b>State Code</b> : <?php echo  $invoice_info->state_code; ?></p>
        <!-- <p> <b>GSTIN</b> : <?php echo $party_gst_no; ?> </p> -->
      </td>
      <td colspan="2" Width="40%" valign="top">
        <p style="padding-top:8px;"> <b>Invoice No</b> : <?php echo $invoice_info->adv_id; ?></p>
        <p style="padding-top:8px;"> <b>Date </b> : <?php echo $invoice_info->paid_date;; ?></p>
      </td>
    </tr>
  ...
  <table class="table table-bordered invoice-tbl-2"  width="100%">
    ...
    <tr  style="padding:10px; padding:10px;">
      ...
      <td style="padding:10px; text-align:center;">Advertisement</td>
      <td style="padding:10px; text-align:center;" > </td>
      <td style="padding:10px; text-align:center;" > 18%</td>
      <td style="padding:10px; text-align:center;">1</td>
      <td style="padding:10px; text-align:center;"><?php echo $invoice_info->paid_final_amt; ?></td>
      <td style="padding:10px; text-align:center;"><?php echo $invoice_info->paid_final_amt; ?></td>
    </tr>
  <!-- <?php
  $k=5-$i;
  ...
  <?php } ?> -->
    <tr>
      <td colspan="4" rowspan="" valign="top">
        <p style="margin-top:10px;"><b>GST Amount : <?php echo $this->numbertowords->convert_number($invoice_info->paid_gst); ?> Only</b> </p><hr style="margin-left:-10px;">
        <p><b>Net Amount : <?php echo $this->numbertowords->convert_number($invoice_info->paid_amt); ?> Only</b> </p>
      ...
      <td colspan="1" Width="15%" valign="top">
        <p style="text-align:right; padding-right:15px;"><?php echo number_format($invoice_info->paid_final_amt,2); ?> </p> <hr style="margin-left:-10px;">
        <?php if($company_statecode == $invoice_info->state_code){ ?>
          <p style="text-align:right; padding-right:15px;"><?php echo number_format($invoice_info->paid_gst/2,2); ?> </p> <hr style="margin-left:-10px;">
          <p style="text-align:right; padding-right:15px;"><?php echo number_format($invoice_info->paid_gst/2,2); ?> </p> <hr style="margin-left:-10px;">
        <?php } else{ ?>
          <p style="text-align:right; padding-right:15px;"><?php echo number_format($invoice_info->paid_gst,2); ?> </p> <hr style="margin-left:-10px;">
        <?php } ?>


        <p style="text-align:right; padding-right:15px;"> <?php echo round($invoice_info->paid_amt); ?> </p>
      </td>
