        ...
        <div class="row">
          ...
          <div class="col-md-8 offset-md-2">
            ...
            <div class="card card-default">
              ...
              <!-- form start -->
              <?php if(isset($update)){ ?>
                <form id="form_action" role="form" action="../update_state" method="post">
                  <input type="hidden" name="state_id" value="<?php echo $state_id; ?>">
              <?php } else{ ?>
                <form id="form_action" role="form" action="save_state" method="post">
              <?php } ?>
                <div class="card-body row">
                  ...
                  <div class="form-group col-md-12">
                    <input type="text" class="form-control required title-case text" name="state_name" id="state_name" value="<?php if(isset($state_name)){ echo $state_name; } ?>" title="Enter State Name" placeholder="Enter State Name" required>
                  </div>
                </div>
                <!-- /.card-body -->
