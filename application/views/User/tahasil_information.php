        ...
        <div class="row">
          ...
          <div class="col-md-8 offset-md-2">
            ...
            <div class="card card-default">
              ...
              <!-- form start -->
              <?php if(isset($update)){ ?>
                <form id="form_action" role="form" action="../update_tahasil" method="post">
                  <input type="hidden" name="tahasil_id" value="<?php echo $tahasil_id; ?>">
              <?php } else{ ?>
                <form id="form_action" role="form" action="save_tahasil" method="post">
              <?php } ?>
              ...
              <select class="form-control select2" name="district_id" id="district_id" title="Select District" data-placeholder="Select District" style="width: 100%;" required>
                ...
                <?php foreach ($district_list as $district_list1) { ?>
                  ...
                  <div class="form-group col-md-12">
                    <input type="text" class="form-control required title-case text" name="tahasil_name" id="tahasil_name" value="<?php if(isset($tahasil_name)){ echo $tahasil_name; } ?>" placeholder="Enter Tahasil Name" required>
                  </div>
                </div>
                <!-- /.card-body -->
