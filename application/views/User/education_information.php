        ...
        <div class="row">
          ...
          <div class="col-md-8 offset-md-2">
            ...
            <div class="card card-default">
              ...
              <!-- form start -->
              <?php if(isset($update)){ ?>
                <form id="form_action" role="form" action="../update_education" method="post">
                  <input type="hidden" name="education_id" value="<?php echo $education_id; ?>">
              <?php } else{ ?>
                <form id="form_action" role="form" action="save_education" method="post">
              <?php } ?>
                <div class="card-body row">
                  <div class="form-group col-md-12">
                    <input type="text" class="form-control required title-case text" name="education_name" id="education_name" value="<?php if(isset($education_name)){ echo $education_name; } ?>" placeholder="Enter Education" required>
                  </div>
