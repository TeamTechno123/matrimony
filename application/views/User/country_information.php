        ...
        <div class="row">
          ...
          <div class="col-md-8 offset-md-2">
            ...
            <div class="card card-default">
              ...
              <!-- form start -->
              <?php if(isset($update)){ ?>
                <form id="form_action" role="form" action="../update_country" method="post">
                  <input type="hidden" name="country_id" value="<?php echo $country_id; ?>">
              <?php } else{ ?>
                <form id="form_action" role="form" action="save_country" method="post">
              <?php } ?>
                <div class="card-body row">
                  <div class="form-group col-md-12">
                    <input type="text" class="form-control required title-case text" name="country_name" id="country_name" value="<?php if(isset($country_name)){ echo $country_name; } ?>" placeholder="Enter Country Name" required>
                  </div>
