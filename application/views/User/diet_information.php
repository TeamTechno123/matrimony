          ...
          <div class="col-md-8 offset-md-2">
            ...
            <div class="card card-default">
              <div class="card-header">
                <h3 class="card-title">Diet Information</h3>
              </div>
              ...
              <!-- form start -->
              <?php if(isset($update)){ ?>
                <form id="form_action" role="form" action="../update_diet" method="post">
                  <input type="hidden" name="diet_id" value="<?php echo $diet_id; ?>">
              <?php } else{ ?>
                <form id="form_action" role="form" action="save_diet" method="post">
              <?php } ?>
                <div class="card-body row">
                  <div class="form-group col-md-12">
                    <input type="text" class="form-control required title-case text" name="diet_name" id="diet_name" value="<?php if(isset($diet_name)){ echo $diet_name; } ?>" placeholder="Enter Diet" required>
                  </div>
