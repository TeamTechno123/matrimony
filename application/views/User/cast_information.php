          ...
          <div class="col-md-8 offset-md-2">
            ...
            <div class="card card-default">
              <div class="card-header">
                <h3 class="card-title">Cast Information</h3>
              </div>
              ...
              <!-- form start -->
              <?php if(isset($update)){ ?>
                <form id="form_action" role="form" action="../update_cast" method="post">
                  <input type="hidden" name="cast_id" value="<?php echo $cast_id; ?>">
              <?php } else{ ?>
                <form id="form_action" role="form" action="save_cast" method="post">
              <?php } ?>
                <div class="card-body row">
                  ...
                  <div class="form-group col-md-12">
                    <input type="text" class="form-control required title-case text" name="cast_name" id="cast_name" value="<?php if(isset($cast_name)){ echo $cast_name; } ?>" placeholder="Enter Cast Name" required>
                  </div>
