            ...
            <div class="card card-default">
              ...
              <?php } ?>
                ...
                <div class="card-body row">
                  ...
                  <div class="form-group col-md-6">
                    <input type="number" class="form-control" name="company_pincode" id="company_pincode" value="<?php if(isset($company_pincode)){ echo $company_pincode; } ?>" placeholder="Statecode">
                  </div>
                  <div class="form-group col-md-6">
