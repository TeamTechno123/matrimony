        ...
        <div class="row">
          ...
          <div class="col-md-8 offset-md-2">
            ...
            <div class="card card-default">
              ...
              <!-- form start -->
              <?php if(isset($update)){ ?>
                <form id="form_action" role="form" action="../update_language" method="post">
                  <input type="hidden" name="language_id" value="<?php echo $language_id; ?>">
              <?php } else{ ?>
                <form id="form_action" role="form" action="save_language" method="post">
              <?php } ?>
                <div class="card-body row">
                  <div class="form-group col-md-12">
                    <input type="text" class="form-control required title-case text" name="language_name" id="language_name" value="<?php if(isset($language_name)){ echo $language_name; } ?>" title="Enter Language Name" placeholder="Enter Language Name" required>
                  </div>
